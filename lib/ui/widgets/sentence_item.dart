...
import 'package:jeka/ui/screens/edit/edit_sentence.dart';

class SentenceItem extends StatefulWidget {

  DocumentSnapshot snap;

  SentenceItem(this.snap);

  @override
  _SentenceItemState createState() => _SentenceItemState();
                ...
                trailing: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                        MaterialPageRoute(builder: (context) => EditSentence(widget.snap.documentID)),
                      );
                    }),
              )
            ],
